function params = sample_parameters_for_figure_3_middle
%SAMPLE_PARAMETERS_FOR_FIGURE_3_MIDDLE Samples parameters for the 
% experiment from Figure 3 (middle) of the supplementary material 
