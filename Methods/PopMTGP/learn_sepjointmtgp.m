function [logtheta_all, nl] = learn_sepjointmtgp(logtheta_all, deriv_range, data, niter)
...
[cov_func, time, signals, num_features, rank_approx, num_obs, task_index, time_index] = deal(data{:});

[logtheta, nl] = minimize(logtheta0,'nmargl_sepjointmtgp',niter, logtheta_all, ...
			 cov_func, time, signals,...
