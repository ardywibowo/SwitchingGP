function selected_set_index = FeatureSetSelect(model, feature_cell, selected_feature_set_num, pred_lag, max_duration, signals_test, context_test)%for cross validation, substitute model by "model cell"
...
%selected_set_index is comprised of the indexes of feature_cell

foldnum = 1;

feature_set_num = length(feature_cell);
selected_set_index = [];
